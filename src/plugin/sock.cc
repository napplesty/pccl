...
//                                 size_t size, uint64_t wrId, uint64_t
//                                 srcOffset, uint64_t dstOffset) {
//   SockWr &wr = stageOp();
//   wr.wr_id = wrId;
...
// PCCL_API void SockQp::stageAtomicAdd(const SockMr *mr, const SockMrInfo
// &info,
...
// PCCL_API void SockQp::stageSendWithImm(const SockMr *mr, const SockMrInfo
// &info,
//                                        uint32_t size, uint64_t wrId,
//                                        uint64_t srcOffset, uint64_t
//                                        dstOffset, unsigned int immData) {
//   SockWr &wr = stageOp();
//   wr.wr_id = wrId;
...
//     result =
//         connect(sock_fd, (struct sockaddr *)&sockaddr_v4,
//         sizeof(sockaddr_v4));
//   } else {
//     struct sockaddr_in6 sockaddr_v6;
//     memset(&sockaddr_v6, 0, sizeof(sockaddr_v6));
...
//     result =
//         connect(sock_fd, (struct sockaddr *)&sockaddr_v6,
//         sizeof(sockaddr_v6));
//   }
...
//     ssize_t result = send(socket_fd, data + bytes_sent, total_size -
//     bytes_sent,
//                           MSG_NOSIGNAL);
//     if (result < 0) {
